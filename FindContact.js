...
try {
    addressBookArray.push(new Contact("Vishnu", "Reddy", "#1ac156", "Hyderabad", "Telangana", "123 456", "91 9553275711", "vishnu95532@gmail.com"));
} catch (e) {
    console.error(e);
}

try {
    addressBookArray.push(new Contact("Rakesh", "Reddy", "#7ui234", "Bengaluru", "Karnataka", "456 123", "91 9808909761", "rakesh@gmail.com"));
} catch (e) {
    console.error(e);
}

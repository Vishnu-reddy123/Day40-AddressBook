...
let fourthContact = new Contact("Arjun", "Varma", "#5676gf", "Cuttack", "Orissa", "789 098", "91 9987654321", "arjun@gmail.com");
...
console.log("\nSearch Rakesh In City - Bengaluru");
console.log(searchContactByCity("Rakesh", "Bengaluru"));

console.log("\nSearch Rakesh In State - Karnataka");
console.log(searchContactByState("Rakesh", "Karnataka"));


console.log("\nView Contacts By City : Bengaluru \n" );
console.log(viewContactsByCity("Bengaluru"));
